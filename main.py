...
label1 = Label(root, text="WELCOME TO ZODIAC SIGN CALCULATOR", borderwidth=18, bg="black",fg="red")
label1.config(font=("Britannic Bold",15))
label1.grid(row=0, column=0, columnspan=2)
label2 = Label(root, text="BIRTH DATE :", borderwidth=40, bg="green")
label2.config(font=("Britannic Bold", 15))
label2.grid(row=1, column=0)
label3 = Label(root, text="BIRTH MONTH :", borderwidth=30, bg="yellow")
label3.config(font=("Britannic Bold", 15))
label3.grid(row=2, column=0)
entry1 = Entry(root, borderwidth=3, width=10)
entry1.grid(row=1, column=1)
entry2 = Entry(root, borderwidth=3, width=10)
entry1.grid(row=1, column=1)
entry2.grid(row=2, column=1)
date = entry1.get()
month = entry2.get()
get_button = Button(root, text="GET ZODIAC SIGN", anchor=CENTER, command=lambda: get_zodiac(date, month), height=2, width=25, bg="black", fg="red")
